...
A compléter par Maxime

\section{Spécifications}

\subsection{Fightly}
Fightly est un jeu au tour par tour, par navigateur sur internet.
Le jeu se déroule sur une carte composée de cases contigues, les joueurs se connectent, composent leurs unitées de soldats, les placent sur la carte et s'affrontent chacun son tour en manipulant et faisant déplacer leurs unités.
Le but du projet est de fournir un moteur de jeu qui permet d'implémenter les fonctionnalités de tout ce qui est en lien avec le déroulement du jeu. A savoir, la gestion de la communication, des parties, des règles.
Par ailleurs, il y aura un serveur dedié à l'authentification et la gestion des graphismes et dont on aura pas la charge. 

Pour plus de détails sur Fightly, voici le lien disponible sur le forum du jeu \lien{http://fightly-dev-lqbs.fr/downloads/fightly_game-concept-document_2010-07-23.pdf}
\subsection{Serveur}
